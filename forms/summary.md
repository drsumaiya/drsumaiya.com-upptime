...
**Last Probe Run:** `2026-09-20 09:13:41 UTC`  
**Total Targets:** 4 | **Passed:** 4 | **Failed:** 0

| Form Target | Page Status | Submission Route | Assets Verified | Health |
| :--- | :---: | :---: | :---: | :---: |
| [DrSumaiya - Consultation Inquiry Form](https://drsumaiya.com/inquiry-form/) | HTTP 200 (1974.94ms) | `OPTIONS` 200 | 4 assets | 🟢 **PASS** |
| [DrSumaiya - Patient History Form](https://drsumaiya.com/form/) | HTTP 200 (1813.01ms) | Iframe HTTP 200 | 1 assets | 🟢 **PASS** |
| [IQS - Admissions & Course Inquiry Form](https://iqs.org.in/inquiry/) | HTTP 200 (369.73ms) | `OPTIONS` 200 | 0 assets | 🟢 **PASS** |
| [Hifz Focus - Student Onboarding Form](https://hifz.iqs.org.in/onboarding) | HTTP 200 (52.52ms) | Client-side | 6 assets | 🟢 **PASS** |
