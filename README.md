...
| **Estimated Monthly Runner Usage** | **~7,000 – 9,000 minutes/month**<br>*(Uptime checks every 5 min + Daily Lighthouse + Graphs + Summaries)* | **Exceeds free limits by 5,000+ min/month**<br>(Costs ~$40 – $70/month in overages) |
...
* **Largest Contentful Paint (LCP)**: `5.0 s` *(Target: ≤ 2.5s)*
* **First Contentful Paint (FCP)**: `2.9 s` *(Target: ≤ 1.8s)*
* **Total Blocking Time (TBT)**: `60 ms` *(Target: ≤ 200ms)*
* **Cumulative Layout Shift (CLS)**: `1.023` *(Target: ≤ 0.1)*
* **Speed Index**: `3.5 s`
```
